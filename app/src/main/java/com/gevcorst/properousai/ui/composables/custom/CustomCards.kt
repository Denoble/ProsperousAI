...
import com.gevcorst.properousai.ui.composables.ext.dropdownSelector
...
fun DangerousCardEditor(
    ...
    CardEditor(title, icon, content,
        onEditClick, MaterialTheme.colorScheme.primary, modifier)
}
...
fun RegularCardEditor(
    ...
    CardEditor(title, icon, content,
        onEditClick, MaterialTheme.colorScheme.onSurface, modifier)
}
